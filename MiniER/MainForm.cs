    ...
    public partial class MainForm : Form {
        ...
        private void btn_reverse_Click(object sender, EventArgs e) {
            ...
            if(r.ShowDialog() == System.Windows.Forms.DialogResult.OK) {
                if(r.cb_update_schema.Checked)
                    foreach(var table in editPanel1.Schema.TableList) {
                        Table tbl = r.Schema.TableList.FirstOrDefault(n => n.TableName == table.TableName);
                        if(tbl != null) {
                            tbl.Left = table.Left;
                            tbl.Top = table.Top;
                        }
